...
def get_dataset(comp_dir: Path,
    ...
    trait_clip = (0.0, None)
    if trait_col in ['d13c', 'd15n']:
        trait_clip = (None, None)
...
def get_xtransforms(ds_key: str) -> Dict:
    ...
    ranges = [(400, 1320)]
    xtransforms['vnir'] = [KeepWavelengths(keep_ranges=ranges),
                           UnitVectorize()]
    
    ranges = [(400, 1320),
              (1450, 1800),
              (2000, 2400)]
    xtransforms['swir'] = [KeepWavelengths(keep_ranges=ranges),
                           UnitVectorize()]
    
    ranges = [(400, 1320),
              (1450, 1800),
              (2000, 2400)]
    xtransforms['all'] = [KeepWavelengths(keep_ranges=ranges),
                          UnitVectorize()]
